...
import Rocky from "../../../assets/quotes/rocky-quotes.json";
    ...
    >
      <Carousel play={10000} fill>
        ...
        <QuoteCarouselItem
          ...
          textColor="gold"
        />
        <QuoteCarouselItem quote={Rocky.rocky_4} index={15} textColor="#301901" textPosition={{ top: "20%", right: "40%" }} />
        <QuoteCarouselItem
          quote={Rocky.rocky_5}
          index={14}
          imagePosition="center"
        ...
        />
        <QuoteCarouselItem quote={Rocky.rocky_7} index={8} textColor="lightcoral" textPosition={{ bottom: "5%" }} />
